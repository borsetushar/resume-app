  ...
  return (
    <>
         <Box sx={{
            ...
            <Stack direction={'row'} height={'110px'} backgroundColor={'white'}>
                 <Box >
                   {personalInfoData.map((personalInfoData,index)=>(
                           <Box key={index} >
                                <Box>
                                 <img src={personalInfoData.image} alt='perimg' style={{ width: '130px', height: '120px',borderRadius :'50%', marginTop: '-25px' }} />
                                </Box>
                          </Box>
                    ))
                    }
